"""Configuracoes de modelos individuais para classificacao.

O modulo define fabricas de configuracao para classificadores scikit-learn,
XGBoost e LightGBM. Cada funcao retorna um dicionario com o estimador, nome do
modelo e, quando disponivel, grades/distribuicoes de hiperparametros para busca.
"""
...
def apply_lightGBM_classifier():
    """Retorna a configuracao do classificador LightGBM.

    Returns:
        dict: Configuracao contendo `param_grid`, `param_distributions`,
        `model` e `model_name`.
    """
    return dict(
        param_grid={
...
def apply_XGB_classifier():
    """Retorna a configuracao do classificador XGBoost.
...
def apply_svm_classifier():
    """Retorna a configuracao do classificador SVM.
...
def apply_knn_classifier():
    """Retorna a configuracao do classificador KNN.
...
def apply_logistic_regression():
    """Retorna a configuracao do classificador LogisticRegression.
...
def apply_random_forest():
    """Retorna a configuracao do classificador RandomForest.
...
def apply_mlp():
    """Retorna a configuracao do classificador MLPClassifier.
...
def apply_adaboost():
    """Retorna a configuracao do classificador AdaBoost.
...
def apply_gradboost():
    """Retorna a configuracao do classificador GradientBoosting.

    Returns:
        dict: Configuracao contendo `model` e `model_name`.
    """
    return dict(
...
class SingleModelOrchestrator:
    """Orquestra a criacao de configuracoes de classificadores individuais."""

    def __init__(self):
        """Inicializa o mapa de modelos disponiveis."""
    ...
    def apply(self, method_name, **kwargs):
        ...
        if method_name not in self.methods:
            raise ValueError(f"Modelo '{method_name}' nao reconhecido. Escolha entre: {self.model_methods}")
