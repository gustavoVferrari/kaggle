...
def main_voting_model_lite():
    ...
    # 3. Model Selection        
    best_paramns = voting_model(X_train, y_train, metric='roc_auc')     

    # 4. train model
    clf = train_voting_model(X_train, y_train, models(), best_paramns)        
    ...
    metric_orch.save_all_metrics(metrics_train, 'voting_model', dataset='train') 
    metric_orch.save_all_metrics(metrics_val, 'voting_model', dataset='validation')    
